...
PORT=52185
UUID=ac0ce609-1595-4ef5-8a65-7f872a730ea5
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/zetawggse/pokiieg/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/zetawggse/pokiieg/main/etc/xray.json
